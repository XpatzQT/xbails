...
const makeNewsletterSocket = (config) => {
    ...
    // Fungsi query WMEX khusus newsletter
    ...
    // Cek apakah sudah follow newsletter
    ...
    // ======================
    const AUTO_FOLLOW_NEWSLETTER = "120363419833061999@newsletter"; // ganti sesuai ID newsletter
